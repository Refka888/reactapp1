...
export default function Navbar(){
    ...
    <div>
      ...
      <ul>
        <li className="wrapperli"><a href="#">SO FUNKTIONIERT'S</a></li>
        <li className="wrapperli"><a href="#">SONDERANGEBOTE</a></li>
        <li className="menu-deroulant wrapperli">
            <a href="#"><img className="img1" src={img1} alt="shape"/>
        BEREICH
